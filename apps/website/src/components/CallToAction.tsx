        ...
        <div className="w-full [@media(min-width:1179px)]:w-[33%] [@media(min-width:1179px)]:max-w-[32%] ">
          ...
          <div className="grid grid-cols-2 gap-4 mt-10 max-w-full">
            <button 
              ...
              className=" hover:bg-[#FFC1A0] border-2  border-[#FCA17A] text-black px-2 py-2 rounded-md text-sm sm:text-base md:text-lg lg:text-base xl:text-base [@media(min-width:1400px)]:text-xl font-medium transition w-full"
            >
              Send us a message
            </button>
            <button 
