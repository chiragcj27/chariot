...
export default function Footer() {
  return (
    <footer className="bg-seafoam lg:-mt-20 text-gray-800">
      {/* Main Footer Content */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/portfolio" className="text-base font-secondary text-gray-700 hover:text-gray-900 transition-colors">
                    Portfolio
                  </Link>
                </li>
                <li>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-base font-secondary text-gray-700">123 Business Ave</p>
                    <p className="text-base font-secondary text-gray-700">Suite 100</p>
                    <p className="text-base font-secondary text-gray-700">City, State 12345</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <a href="mailto:hello@chariot.com" className="text-base font-secondary text-gray-700 hover:text-gray-900 transition-colors">
                    hello@chariot.com
                  </a>
                </div>
                <div className="flex items-center space-x-3">
