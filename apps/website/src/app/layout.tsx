...
export const metadata: Metadata = {
  title: "Chariot - Creative & Marketing Services for Jewelers",
  description: "Branding, websites, catalogs, campaigns - everything your jewelry business needs to grow, all in one place. Built for Jewelers, by Jewelers.",
  other: {
