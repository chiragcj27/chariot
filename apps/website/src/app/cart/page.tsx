      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <div className="space-y-2">
            <Link href="/">
              <Button variant="outline" className="w-full bg-white text-gray-700 border-2 border-[#FCA17A] py-2 px-5 rounded-lg transition-colors hover:bg-sunrise">
                Continue Shopping
              </Button>
            </Link>
          </div>
        ...
        <div className="border-b border-gray-200 py-2">
          <div className="flex flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center flex-wrap gap-4 sm:gap-6">
              ...
              <div className="px-3 py-2 bg-black text-white rounded-lg text-xs sm:text-sm font-medium">
                Payment Pending
              </div>
            </div>
          </div>
